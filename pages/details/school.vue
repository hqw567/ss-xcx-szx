		...
		<view class="container" v-if="schoolData && schoolData.title">
			<view class="header">
				<view class="top">
					...
					<view class="name">
						<view class="title">{{ schoolData.title }}</view>
						<view class="tags">
			...
			<view class="info unifycase">
				...
				<view class="box">
					<view class="item">举办者：{{ schoolData.jubanzhe }}</view>
					<view class="item">建校时间：{{ schoolData.jianxiaoshijian }}</view>
					<view class="item">招生代码：{{ schoolData.zhaoshengdaima }}</view>
					<view class="item">在校生人数：{{ schoolData.xueshengrenshu }}</view>
					<view class="item">学校面积：{{ schoolData.xuexiaomianji }}</view>
					<view class="item">教学设备价值：{{ schoolData.shebeijiazhi }}</view>
					<view class="item">教职工总数：{{ schoolData.xueshengrenshu }}</view>
					<view class="item">挂靠大专学校：{{ schoolData.guahaodazhuan }}</view>
					<view class="item">学校地址：{{ schoolData.xuexiaodizhi }}</view>
					<view class="item" v-if="schoolData.xuexiaogw">
						学校官网：{{ schoolData.xuexiaogw }}
					</view>
				</view>
			</view>
